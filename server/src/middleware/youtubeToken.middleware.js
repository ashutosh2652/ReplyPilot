...
export async function getValidYoutubeToken(userId) {
    ...
    // 5. Clean up on both settle paths
...
/**
 * Middleware to fetch or refresh YouTube token and attach it to req.ytToken
 */
export default async function(req, res, next) {
    try {
        ...
        // Use the centralized internal logic to fetch or refresh the token reliably
